...
public class TodoListManager {
    ...
    public void run() {
        ...
        while (running) {
            ...
            switch (choice) {
                ...
                case 2 -> undo();
                case 3 -> viewList(todoList, "To-Do List");
                case 4 -> viewList(completedTasks, "Completed Tasks");
                case 5 -> { showExitMessage(); running = false; }
            }
        }
    }
    ...
    private void showExitMessage() {
        JOptionPane.showMessageDialog(null, "Exiiitinnnnggggggggg!");
    }
}